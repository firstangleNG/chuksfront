    ...
    <div>
      ...
      <style jsx global>{`
        @media print {
          ...
          .print-area .print\\:border {
            border: 1px solid #000 !important;
          }
          .print-area .print\\:text-center {
            text-align: center !important;
          }
          .print-area .print\\:bg-white {
            background: #fff !important;
          }
          .print-area .print\\:shadow-none {
            box-shadow: none !important;
          }
          .print-area img,
          .print-area .next-image {
            max-width: 120px !important;
            height: auto !important;
          }
          .print-area .text-green-600,
          .print-area .text-green-700,
          .print-area .text-green-800 {
            color: #000 !important;
          }
          .print-area .text-red-600,
          .print-area .text-red-700,
          .print-area .text-red-800 {
            color: #000 !important;
          }
          .print-area .text-yellow-600,
          .print-area .text-yellow-700,
          .print-area .text-yellow-800 {
            color: #000 !important;
          }
      ...
      <div className="print-area bg-white p-2 max-w-3xl mx-auto text-[11px]" style={{ lineHeight: '1.2' }}>
        {/* Letterhead */}
        <div className="flex justify-between items-start mb-2 border-b pb-1">
          <div>
            <div className="flex items-center gap-1 mb-0">
              <div className="relative w-8 h-8 next-image">
                <Image 
        ...
        <div className="mb-4">
          <table className="w-full border-collapse text-[9px]">
            ...
            <tbody>
              <tr>
                <td className="p-1 border">Labor Charges</td>
                <td className="p-1 border text-right">£{invoice.laborCost.toFixed(2)}</td>
              </tr>
              <tr>
                <td className="p-1 border">Parts & Materials</td>
                <td className="p-1 border text-right">£{invoice.partsCost.toFixed(2)}</td>
              </tr>
              <tr>
                <td className="p-1 border">Tax (8%)</td>
                <td className="p-1 border text-right">£{invoice.taxAmount.toFixed(2)}</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="p-1 border font-semibold">Total</td>
                <td className="p-1 border text-right font-semibold">£{invoice.totalAmount.toFixed(2)}</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="flex justify-end gap-3 mt-8 print:hidden print-area print:hidden">
